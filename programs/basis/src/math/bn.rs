...
use crate::error::ErrorCode::BnConversion;
...
impl U256 {
    ...
    /// Convert u256 to u64
    pub fn try_to_u64(self) -> PoolResult<u64> {
        self.try_into().map_err(|_| BnConversion)
    }
    ...
    /// Convert u256 to u128
    pub fn try_to_u128(self) -> PoolResult<u128> {
        self.try_into().map_err(|_| BnConversion)
    }
