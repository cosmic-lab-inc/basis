...
pub fn shares_to_amount(n_shares: u128, total_shares: u128, total_equity: u64) -> PoolResult<u64> {
    validate!(
...
pub fn amount_to_shares(amount: u64, total_shares: u128, total_equity: u64) -> PoolResult<u128> {
...
pub fn get_proportion_u128(value: u128, numerator: u128, denominator: u128) -> PoolResult<u128> {
